...
class Ingredient
{
    ...
    #[Assert\NotBlank(message: 'La désignation de l\'ingrédient est obligatoire.')]
     ...
     */
    #[ORM\OneToMany(targetEntity: RecetteIngredient::class, mappedBy: 'ingredient', cascade: ['remove'])]
